...
# --- GENERAR PDF ---
@main.route('/reimprimir-guia/<pedido>')
...
@main.route('/generar-checklist/<pedido>', methods=['GET', 'POST'])
...
@main.route('/reimprimir-checklist/<pedido>')
